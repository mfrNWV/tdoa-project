...
gcc -Wall -pthread -o rawMCP3008 rawMCP3008_2.c -lpigpio
...
#define ADCS 3    // Number of connected MCP3008.
...
#define BUFFER 460       // Generally make this buffer as large as possible.

#define REPEAT_MICROS 20 // Reading every x microseconds.

#define SAMPLES 250000  // Number of samples to take,
